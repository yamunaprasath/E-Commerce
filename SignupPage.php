...
include 'UserDetails.php';
    ...
    if (isset($_POST['submit'])) {
        ...
        if($password === $confirmPassword) {
            $products = new UserDetails();
            $products->setFirstName($firstName);
            $products->getFirstName();
            $products->setLastName($lastName);
            $products->setEmailId($emailId);
            $products->setPassword($password);
            $products->setConfirmPassword($confirmPassword);
            $products->addDetails();
        } else{
    ...
    <path fill="#008060" d="M398.44,218.49l-222.41,222.4c-56.76-56.86-91.87-135.36-91.87-222.06c0-86.87,35.25-165.51,92.22-222.4
      ...
      <div class="row bs-gutter">
        ...
        <form action="" method ='POST' name='getuserdetails'>
            ...
            <input  class="form-control"type="mail" name='emailId'><br>
